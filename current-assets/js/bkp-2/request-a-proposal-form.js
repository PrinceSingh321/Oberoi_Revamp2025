...
$(function () {
    ...
    try {
        ...
        $(".imageWithRightTextWrapp .btnRequestAProposal").click(function () {
            $(".errorMsg").html("");
        ...
        $(".com_TwoImageSlider-img-sec .btnRequestAProposal").click(function () {
            $(".imageWithRightTextWrapp .btnRequestAProposal").addClass("active");
            $(".request-a-proposal-form").show();
            ...
            eventvenu = $(this).attr("data-venue").split(",");
            seatingstyle = $(this).attr("data-seating-type").split(",");
            selectedvanuebind = $(this).attr("data-bind");
            //console.log("rrr" + selectedvanuebind);
